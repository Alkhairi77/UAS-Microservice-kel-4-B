<x-app>
    <x-slot:title>Tambah Jenis Sampah</x-slot:title>
    ...
    <div class="container px-6 mx-auto">
        ...
        <x-card>
            <form method="POST" action="{{ route('admin.jenis-sampah.store') }}" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <x-input type="text" name="nama" value="{{ old('nama') }}" placeholder="Masukkan nama jenis sampah" required />
                    @error('nama')
                ...
                <div>
                    ...
                    <x-input type="number" name="harga_per_kg" value="{{ old('harga_per_kg') }}" step="0.01" placeholder="Masukkan harga per KG" required />
                    @error('harga_per_kg')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <x-textarea name="deskripsi" rows="4" placeholder="Masukkan deskripsi">{{ old('deskripsi') }}</x-textarea>
                    @error('deskripsi')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
